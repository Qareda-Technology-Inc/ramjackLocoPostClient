          ...
          {assignments.length > 0 ? (
            assignments.map((assignment) => (
              <div key={assignment._id} className="border rounded-lg p-4 hover:shadow-lg transition duration-200 bg-white">
                <h3 className="text-l font-semibold">{assignment.site.name} - <span className="text-gray-500" >{assignment.site.country}</span></h3>
                ...
                <Button variant="primary" onClick={() => handleViewDetails(assignment)} className="mt-2 text-sm">
                  View Details
                </Button>
              </div>
            ))
