...
const fakers = {
  fakeUsers() {
    const users: Array<Omit<Users, "email">> = [
      { name: "John Owusu", gender: "male" },
      { name: "Amankwa Dwomo", gender: "male" },
      { name: "Faesatu Aduke", gender: "male" },
      { name: "Ishmael Tenge", gender: "male" },
      { name: "Richmond Nketia", gender: "male" },
      { name: "Duncan Jonathan", gender: "male" },
      { name: "Brad Pitt", gender: "male" },
      { name: "Angelina Jolie", gender: "female" },
      { name: "Leonardo DiCat", gender: "male" },
  ...
  fakeFiles() {
    const files = [
      { fileName: "Amankwa Dwomo ", type: "MP4", size: "20 MB" },
